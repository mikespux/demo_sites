        ...
        <div class="col-lg-4">
          <div class="well bs-component">
            <form class="form-horizontal" action="" method="GET">
              ...
              <div class="form-group">
                <div class="col-lg-12">
                  <label class="control-label" for="focusedInput">Departure Date</label> &nbsp;&nbsp;<img src="images2/cal.gif" onclick="javascript:NewCssCal('departure_date')" style="cursor:pointer"/>
              ...
              <div class="form-group">
                <div class="col-lg-12">
                  <label class="control-label" for="focusedInput">Arrival Date</label>&nbsp;&nbsp;<img src="images2/cal.gif" onclick="javascript:NewCssCal('return_date')" style="cursor:pointer"/>
