							...
							if(isset($_GET['chose_to'])===true) {
								if(isset($_GET['chose_fro'])===true) {
									...
									$fro = $_GET['chose_fro'];
										...
										while($row1 = mysql_fetch_assoc($r1)) {
											...
											if($class==='Economy') {
												if(($counta+$countc)<=$row1['e_seats_left']) {
													...
													echo 'Cost of '.$counta.' adult(s): '.$counta.' * KSh. '.$row1['e_price'].' =  KSh. '.$eat1.'<br>';
													$ect1 = ($countc * $row1['e_price']) * 0.75;
													echo 'Cost of '.$countc.' child: 75% of '.$countc.' * KSh. '.$row1['e_price'].' = KSh. '.$ect1.'<br>';
													$etax1 = 500;
													echo 'Airport Tax: KSh. 100 <br>';
													echo 'Fuel Tax: KSh. 100 <br>';
													echo 'Service Tax: KSh. 300 <br>';
													echo 'Total Tax: KSh. '.$etax1.'<br><br>';
													$etot1 = $eat1 + $ect1 + $etax1;
													echo '<legend>Cost of one trip is KSh. '.$etot1.'</legend><hr>';
												}
												else {
												...
												if(($counta+$countc)<=$row1['b_seats_left']) {
													...
													echo 'Cost of '.$counta.' adult(s): '.$counta.' * KSh. '.$row1['b_price'].' =  KSh. '.$bat1.'<br>';
													$bct1 = ($countc * $row1['b_price']) * 0.75;
													echo 'Cost of '.$countc.' child: 75% of '.$countc.' * KSh. '.$row1['b_price'].' = KSh. '.$bct1.'<br>';
													$btax1 = 1500;
													echo 'Airport Tax: KSh. 200 <br>';
													echo 'Fuel Tax: KSh. 200 <br>';
													echo 'Service Tax: KSh. 1100 <br>';
													echo 'Total Tax: KSh. '.$btax1.'<br><br>';
													$btot1 = $bat1 + $bct1 + $btax1;
													echo '<legend>Cost of one trip is KSh. '.$btot1.'</legend><hr>';
												}
												else {
													echo 'Not enough available seats. Sorry, please check some other flight!';
													header("refresh:10; url=index.php");
										...
										while($row2 = mysql_fetch_assoc($r2)) {
											...
											if($class==='Economy') {
												if(($counta+$countc)<=$row2['e_seats_left']) {
													...
													echo 'Cost of '.$counta.' adult(s): '.$counta.' * KSh. '.$row2['e_price'].' =  KSh. '.$eat2.'<br>';
													$ect2 = ($countc * $row2['e_price']) * 0.75;
													echo 'Cost of '.$countc.' child: 75% of '.$countc.' * KSh. '.$row2['e_price'].' = KSh. '.$ect2.'<br>';
													$etax2 = 500;
													echo 'Airport Tax: KSh. 100 <br>';
													echo 'Fuel Tax: KSh. 100 <br>';
													echo 'Service Tax: KSh. 300 <br>';
													echo 'Total Tax: KSh. '.$etax2.'<br><br>';
													$etot2 = $eat2 + $ect2 + $etax2;
													echo '<legend>Cost of return trip is KSh. '.$etot2.'</legend><hr>';
												}
												else {
													echo 'Not enough available seats. Sorry, please check some other flight!';
													header("refresh:10; url=index.php");
												...
												if(($counta+$countc)<=$row2['b_seats_left']) {
													...
													echo 'Cost of '.$counta.' adult(s): '.$counta.' * KSh. '.$row2['b_price'].' =  KSh. '.$bat2.'<br>';
													$bct2 = ($countc * $row2['b_price']) * 0.75;
													echo 'Cost of '.$countc.' child: 75% of '.$countc.' * KSh. '.$row2['b_price'].' = KSh. '.$bct2.'<br>';
													$btax2 = 1500;
													echo 'Airport Tax: KSh. 200 <br>';
													echo 'Fuel Tax: KSh. 200 <br>';
													echo 'Service Tax: KSh. 1100 <br>';
													echo 'Total Tax: KSh. '.$btax2.'<br><br>';
													$btot2 = $bat2 + $bct2 + $btax2;
													echo '<legend>Cost of return trip is KSh. '.$btot2.'</legend><hr>';
												}
												else {
													echo 'Not enough available seats. Sorry, please check some other flight!';
													header("refresh:10; url=index.php");
										...
										if($class==='Economy') {
											$etotr = $etot1 + $etot2;
											echo '<legend>Total cost of both the trips is KSh. '.$etotr.'</legend>';
										}
										else if($class==='Business') {
											$btotr = $btot1 + $btot2;
											echo '<legend>Total cost of both the trips is KSh. '.$btotr.'</legend>';
										}
									} 
									...
									while($row1 = mysql_fetch_assoc($r1)) {
										...
										if($class==='Economy') {
											if(($counta+$countc)<=$row1['e_seats_left']) {
												...
												echo 'Total Tax: KSh. '.$etax1.'<br><br>';
												$etot1 = $eat1 + $ect1 + $etax1;
												echo '<legend>Total cost of trip is KSh. '.$etot1.'</legend>';
											}
											else {
												echo 'Not enough available seats. Sorry, please check some other flight!';
												header("refresh:10; url=index.php");
											...
											if(($counta+$countc)<=$row1['b_seats_left']) {
												...
												echo 'Total Tax: KSh. '.$btax1.'<br><br>';
												$btot1 = $bat1 + $bct1 + $btax1;
												echo '<legend>Cost of one trip is KSh. '.$btot1.'</legend>';
											}
											else {
												echo 'Not enough available seats. Sorry, please check some other flight!';
												header("refresh:10; url=index.php");
...
<?php
  ...
  include $_SERVER["DOCUMENT_ROOT"].'/airline/includes/overall/footer.php';
