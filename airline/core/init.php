<?php 
	...
	require $_SERVER["DOCUMENT_ROOT"].'/airline/core/database/connect.php';
	require $_SERVER["DOCUMENT_ROOT"].'/airline/core/functions/general.php';
	require $_SERVER["DOCUMENT_ROOT"].'/airline/core/functions/users.php';
	...
	if(f_logged_in() === true) {
	      ...
	      if($current_file !== 'changepass.php' && $current_file !== 'logout.php' && $f_data['f_passrec'] == 1) {
	      		header('Location: http://localhost/airline/changepass.php?force');
	      		exit();
	      }
	}
